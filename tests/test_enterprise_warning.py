...
def test_audit_report_links_require_matching_disclosed_period_and_preserve_raw_text():
    ...
    pdf = {'returncode': 0, 'data': [{'reportDate': '2025-12-31',
            'filePath': 'https://hwfile.finchina.com/MRGG/CNSESZ_SJBG/2026/report.pdf'}]}
    wrong = {'returncode': 0, 'data': [{'reportDate': '2023-12-31',
            'filePath': 'https://hwfile.finchina.com/MRGG/CNSESZ_SJBG/2024/wrong.pdf'}]}
    session = FakeSession([(endpoint, original, {'code': 'a'}),
